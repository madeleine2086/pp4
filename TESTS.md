...
* [W3C - HTML](https://validator.w3.org/)<br>
   ...
   <img src="documentation/images/tests/html-validation-test.png">
* [W3C - CSS](https://jigsaw.w3.org/css-validator/)<br>
   W3C - CSS was used to validate the CSS code
   <img src="documentation/images/tests/W3c-validation-test.png">

* Lighthouse test for mobile:
<img src="documentation/images/tests/lighthouse-mobile.png">

* Lighthouse for desktop:
<img src="documentation/images/tests/lighthouse-desktop.png">
...
## CRUD
   * Full CRUD functionality is present. Users can view (Read) posts on the page, and once registered and logged in they can comment on a post (Create), update their posts (Update) and delete their posts (Delete) if they wish.
   ...
   <img src="documentation/images/tests/create-comment.png">
   <img src="documentation/images/tests/comment-updated-msg.png">
   <img src="documentation/images/tests/comment-deleted.png">
   <>
